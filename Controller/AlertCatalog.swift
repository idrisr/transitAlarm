...
class AlertCatalog {
    ...
    private class func settingsAction() -> UIAlertAction {
        return UIAlertAction(title: "Settings", style: .Default) { (alertAction) in
    ...
    private class func cancelAction() -> UIAlertAction {
